...
<head>
	...
	<link href="<?php echo get_theme_root_uri(); ?> /meuTema/style.css" rel="stylesheet">
</head>
<body>
	...
	<section class="topo">
		<div class="center">
			...
			<div class="w50 time-imagem">
				<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/equipe.png" />
			</div><!--w50-->
			<div class="clear"></div>
		</div><!--center-->
	</section><!--topo-->
	...
	<section class="clientes-slider">
		...
		<div style="max-width: 700px;margin: 0 auto;overflow: hidden;" class="slider-container">
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/amazon.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/costco.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/dominos.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/uber.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/walmart.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/amazon.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/costco.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/dominos.jpg" />
			<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/uber.jpg" />
			...
			<div class="center">
				...
				<div class="icons-diferenciais">
					...
					<div class="box-single-diferenciais">
						<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/icon1.png" />
					...
					<div class="box-single-diferenciais">
						<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/icon2.png" />
						<h3>Ambientes Mobile</h3>
						<p>Garanta que toda sua comunicação esteja alinhada com seu propósito, cada palavra conta.</p>
					</div><!--box-single-diferenciais-->

					<div class="box-single-diferenciais">
						<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/icon3.png" />
						<h3>Ambientes Mobile</h3>
						<p>Garanta que toda sua comunicação esteja alinhada com seu propósito, cada palavra conta.</p>
					</div><!--box-single-diferenciais-->
	...
	<section class="sobre-time">
		<div class="center">
			...
			<div class="w50 img-time">
				<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/time.png" />
			</div>
			<div class="clear"></div>
		</div>
	</section>
		...
		<div class="center">
			...
			<div class="depoimentos-box">
				<div class="depoimento-single">
					...
					<p>Rafael Della</p>
					<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/rafa.jpg" />
	...
	<section class="metodologia">
		...
		<div class="center">
			...
			<div style="width: 40%;text-align: right;" class="col-footer">
				<img src="<?php echo get_theme_root_uri(); ?> /meuTema/images/logo-footer.png" />
			</div>
		</div>
	</footer>

<script src="<?php echo get_theme_root_uri(); ?> /meuTema/js/jquery.js"></script>
<script src="<?php echo get_theme_root_uri(); ?> /meuTema/js/slick.min.js"></script>
<script src="<?php echo get_theme_root_uri(); ?> /meuTema/js/js.js"></script>
